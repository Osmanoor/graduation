...
**Documentation:** `reports/bm25_baseline_report.md`, `docs/experiments/exp_002_baseline_bm25.md`
...
**Documentation:** `reports/mdpr_baseline_report.md`, `docs/experiments/exp_001_baseline_dense.md`
...
**Documentation:** `ERROR_ANALYSIS_COMPLETE.md`, `research_decisions/error_analysis_phase1_quantitative.md`
...
1. **Quantitative evidence > qualitative observations:** Small sample qualitative analysis (N=20) has low confidence (±21% CI)
