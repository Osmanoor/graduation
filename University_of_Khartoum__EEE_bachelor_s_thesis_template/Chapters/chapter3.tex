...
\paragraph{Fixed Repetition (Query2Doc-style).}
...
\paragraph{Adaptive Repetition (MuGI-style).}
...
\paragraph{Motivation for the Adaptive Variant.}
...
\paragraph{Rationale for Combining Corpus and Blind Samples.}
...
\paragraph{Per-Query Metric Computation.}
...
\paragraph{First-Pass Quality Split.}
