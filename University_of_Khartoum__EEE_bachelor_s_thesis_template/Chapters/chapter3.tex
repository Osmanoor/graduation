...
\begin{enumerate}
    ...
    \item \textbf{Openly available models of 2--8 billion parameters:} Rather than using proprietary API-based models, all experiments used openly available models that run on Google Colab free-tier GPUs. This approach ensures reproducibility and eliminates API costs.
