...
To assess the role of BM25 first-pass quality in CSQE effectiveness, queries were split into two groups based on whether the BM25 first-pass retrieval ($k=5$) returned at least one relevant document (any relevance judgement $> 0$ in the MIRACL qrels for the top-5 retrieved documents). This split enables analysis of whether CSQE gains are driven primarily by successful corpus grounding or by the blind expansion component.
