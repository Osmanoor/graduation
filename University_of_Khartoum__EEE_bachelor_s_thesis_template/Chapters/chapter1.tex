...
\begin{enumerate}[label=\arabic*.]
    ...
    \item To conduct a systematic error analysis of the baseline results---quantifying the overall failure rate, the effect of query length, and retrieval coverage---in order to identify the failure patterns that QE must address and to guide the selection of the enhancement technique.
    ...
    \item To conduct a standardised comparative evaluation of openly available LLMs spanning 2--8 billion parameters as Arabic query-expansion generators, identifying the most effective model under each retrieval paradigm and characterising the performance patterns observed across model families.
    ...
    \item To establish a hybrid sparse--dense fusion baseline without query enhancement, quantifying the performance ceiling that any enhancement-based system must exceed.
...
\textbf{Chapter~\ref{chap:background}} establishes the theoretical foundations required to understand the research. It introduces the core concepts of LLMs, RAG, information retrieval methods (sparse, dense, and hybrid), and QE techniques. The mathematical formulations underlying the retrieval and evaluation methods are presented, followed by detailed descriptions of all models used in the experimental work. The chapter concludes with a review of related literature and the identification of the research gap addressed by this thesis.
