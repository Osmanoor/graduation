...
While dense retrieval has been shown effective and efficient across tasks and languages,
...
answering, and fact verification. A variety of methods such as negative mining (Xiong et al., 2021; Qu
...
et al., 2021) as backbone models significantly outperforms the previous state-of-the-art Contrieveronly zero-shot no-relevance system on 11 queries
...
**Zero-Shot Dense Retrieval** The tasks of zeroshot (dense) retrieval are arguably empirically defined by Thakur et al. (2021) for the neural retrieval community. Their BEIR benchmark consists of diverse retrieval tasks. The paper and
...
_f_ ( _dk_ ) (6)
_d_ ˆ _k∼g_ ( _qij_ _,_ INST _i_ )
...
Several systems that involve fine-tuning on massive _relevance_ data are also included as references. We consider models fine-tuned on MSMARCO and transferred, DPR and ANCE, from
...
Contriever [FT] and mContriever [FT] . These models have run through the state-of-the-art retrieval
...
of changing different instruction LMs and using finetuned encoder. Best w/o relevance and overall models
are marked **bold** .
...
[large language models.](https://doi.org/10.48550/ARXIV.2203.15556)
...
[ficiently teaching an effective dense retriever with](https://doi.org/10.1145/3404835.3462891)
[balanced topic aware sampling. In](https://doi.org/10.1145/3404835.3462891) _Proceedings of_
...
and Edouard Grave. 2021. [Towards unsupervised](http://arxiv.org/abs/2112.09118)
[dense information retrieval with contrastive learning.](http://arxiv.org/abs/2112.09118)
_CoRR_, abs/2112.09118.


Jeff Johnson, Matthijs Douze, and Hervé Jégou. 2017.

[Billion-scale similarity search with gpus.](http://arxiv.org/abs/1702.08734) _CoRR_,
abs/1702.08734.
